...
# Inject the reference-inspired structures at the start of the existing track feature renderer.
needle='    private void drawTrackFeatures(float[] color){'
assert needle in s
s=s.replace(needle,needle+'\n        drawArcadeShowpieces(color);',1)
# Helpers are inserted before drawTrackFeatures.
...
# Final approach remains spline-guided but gets a strong dump into the catcher.
